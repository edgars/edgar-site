+++
title = "A Pragmatic Approach to Rock Your API Strategy"
description = "APIs? What are they? That is the million dollar question nowadays. We could come up with thousands of answers, but we prefer this simple analogy."
author = "Edgar Silva"
date = "2018-10-18"
tags = ["api"]
categories = ["api-strategy" ]
[[images]]
  src = "img/api_strategy.png"
  alt = "API Strategy"
  stretch = "stretchH"
+++
...
![Image for post](https://miro.medium.com/max/60/0*kn7JKRC5r3n9WpK3.png?q=20)

![Image for post](https://miro.medium.com/max/1600/0*kn7JKRC5r3n9WpK3.png)
...
![Image for post](https://miro.medium.com/max/60/0*elu5KIVOEMDBiSAJ.png?q=20)

![Image for post](https://miro.medium.com/max/1600/0*elu5KIVOEMDBiSAJ.png)
...
![Image for post](https://miro.medium.com/max/60/0*zM8j5TqtMjspjjnm.png?q=20)

![Image for post](https://miro.medium.com/max/1600/0*zM8j5TqtMjspjjnm.png)
...
![Image for post](https://miro.medium.com/max/60/0*z777mXxRInVdVeBV.png?q=20)

![Image for post](https://miro.medium.com/max/1600/0*z777mXxRInVdVeBV.png)
...
![Image for post](https://miro.medium.com/max/60/1*bBus5qLIVXSmkUIdJSvd3g.png?q=20)

![Image for post](https://miro.medium.com/max/3516/1*bBus5qLIVXSmkUIdJSvd3g.png)

Proposal of a Very Agile Sprint for an MVA of an API Initiative

## 3.3.1 What are MVP and MVA?

A  **minimum viable product, or MVP**  (or minimum delivery possible in a certain time period), is the minimum of a minimum for your product/idea works. Note that an MVP launch might be totally incremental and versionable, where you can evolve with every new interaction. The main idea of your MVP is that in a single month (or less) you could have something like  [https://api.mycompany.com,](https://api.mycompany.com%2C/)  bootstrapping your API initiative, making it real, and anything else that event might mean for your organization:
...
![Image for post](https://miro.medium.com/max/60/0*Ks6lpHJSJ9idZ0Kx.png?q=20)

![Image for post](https://miro.medium.com/max/1600/0*Ks6lpHJSJ9idZ0Kx.png)
...
![Image for post](https://miro.medium.com/max/60/0*OOYHBOuAvN2pR6Qy.png?q=20)

![Image for post](https://miro.medium.com/max/1600/0*OOYHBOuAvN2pR6Qy.png)
